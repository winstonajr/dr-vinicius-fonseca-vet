    ...
    return(
        <section id="sobre" className="bg-[#F5F9FB] py-16 px-4 md:px-8 text-[#1B2E41] overflow-x-hidden">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
                <motion.div
                    className="mt-6 flex-1 group overflow-hidden rounded-2xl shadow-md"
                ...
                <motion.div
                    ...
                    <p className="text-[#37699E] text-sm mb-3">
                        Vinícius Andrade da Fonseca João
                    </p>
                    <p className="text-[#37699E] font-medium mb-4">
                        CRMV 73773
                    </p>
                    <p className="mb-6 leading-relaxed">
                        Me chamo Vinícius, sou médico Veterinário formado no final de 2024, com mais de 3 anos de experiência em clínicas, internação, emergências e cirurgias. Hoje, atuo com foco em cães e gatos realizando consultas domiciliares, vacinas, exames, curativos, aplicações, fluido terapia e mais — sempre com dedicação ao bem-estar do animal e à satisfação dos tutores.
                    </p>
                    <motion.ul
